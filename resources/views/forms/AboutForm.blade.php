...
<form id="userAboutImageForm" class="form-inline" action="" enctype="multipart/form-data">
    <div id="aboutImage" class="form-group aboutFormGroup">
        <label for="btnAddAboutImage">Upload an Image:(PNG or JPG Only)</label>
        <button id="btnAddAboutImage" class="btn btn-default memberSubmitButton">Upload About Image</button>
        <input id="fileAboutImage" name="member_about_image_1_user_{{$user->user_id}}" type="file">
